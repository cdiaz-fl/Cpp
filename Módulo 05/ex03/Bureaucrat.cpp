...
/*   Updated: 2022/04/11 09:27:49 by cdiaz-fl         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &form)const{
	...
	{
		std::cerr << this->getName() << " cannot sign form " << form.getName();
		std::cerr << ". Not enough grade (bur grade = " << this->getGrade() << " / form s_grade " << form.getSignGrade() << ").\n";
	}
}
